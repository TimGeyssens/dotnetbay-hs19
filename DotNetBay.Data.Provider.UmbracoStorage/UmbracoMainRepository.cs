...
namespace DotNetBay.Data.Provider.UmbracoStorage
{
    public class InMemoryMainRepository : IMainRepository
    {
        ...
        public InMemoryMainRepository(IUmbracoContextFactory umbracoContextFactory, UmbracoMapper mapper, IMemberService memberService)
        {
        ...
        public Auction Update(Auction auction)
        {
            ...
            lock (this.syncRoot)
            {
                ...
                {
                    throw new UmbracoStorageException("This auction does not exist and cannot be updated!");
                }
        ...
        public Bid Add(Bid bid)
        {
            ...
            lock (this.syncRoot)
            {
                ...
                {
                    throw new UmbracoStorageException("This auction does not exist an cannot be added this way!");
                }

                // Does the member exist?
                if (this.loadedData.Members.All(a => a.UniqueId != bid.Bidder.UniqueId))
                {
                    throw new UmbracoStorageException("the bidder does not exist and cannot be added this way!");
                }
            ...
            Func<TNavigationElementType, object> identificationAccessor)
        {
            ...
            {
                throw new UmbracoStorageException("Unable to process objects across contexts!");
            }
        }
